...
public class MudPerson extends UnicastRemoteObject implements Mud.RemoteMudPerson {
    ...
    public MudPerson(String n, String d, PrintWriter out, boolean flag)//!!!!!!!!
    ...
    public boolean getAdminFlag() { return admin; }
    
    public void setAdminFlag(boolean admin) { this.admin = admin; }
