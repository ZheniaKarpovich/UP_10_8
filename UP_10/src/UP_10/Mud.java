...
public class Mud {
    ...
    public interface RemoteMudPlace extends Remote {
        ...
        /** Get the titles of all news here */
        public Vector getNewsTitles() throws RemoteException;
	
        /** Get the names of all ways out of here */
        public Vector getExits() throws RemoteException; // все комнаты с новост€ми
        ...
        public String getNewsContent(String name) 
        ...
        /** Comment news of the form "David: hi everyone" */
        public void comment(RemoteMudPerson speaker, String msg) //RemuteMudPerson заменить на Place
	    throws RemoteException, NotThere;
        
        /**  Comment news of the form "David laughs loudly" */
        public void comment1(RemoteMudPerson speaker, String msg) //RemuteMudPerson заменить на Place
	    throws RemoteException, NotThere;
	
        /** Add a new news in this place */
        public void createNews(RemoteMudPerson who, String name, // удалить, эта функциональность ненужна
				String description) //или только дл€ админа
	    throws RemoteException, NotThere, AlreadyThere;
        
        /**  Remove a news from this place */
        public void removeOldNews(RemoteMudPerson who); // удаление
        
        /**  Find news by date */
        public Vector findNewsByDay(RemoteMudPerson who, Date date);
	
        /** Remove a news from this place */
        public void destroyNews(RemoteMudPerson who, String thing) // удалить, эта функциональность ненужна
	    throws RemoteException, NotThere, NoSuchThing;//или только дл€ админа
	 ...
	 * instead.
	 **/
        public void enter(RemoteMudPerson who, String name, String message) //?????????????? лишн€€ функциональность
     ...
     **/
    public static class NoAdminLaw extends MudException {}
