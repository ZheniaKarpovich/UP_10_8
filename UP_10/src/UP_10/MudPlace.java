    ...
    implements Mud.RemoteMudPlace, Serializable
{
	...
	throws RemoteException, Mud.NotThere, Mud.AlreadyThere//!!!!!удалить или сделать для определенного пользователя
    {
...
//            ld.getMonthValue();
    ...
    public void removeOldNews(RemoteMudPerson who) { // who нкжен  чтобы отслеживать кто именно удалил новости 
	...
	throws RemoteException, Mud.NotThere, Mud.NoSuchThing//!!!!!удалить или сделать для определенного пользователя
    {
    ...
    public void createPlace(Mud.RemoteMudPerson creator,
			    ...
			    String description) //удалить или сделать для определенного пользователя
